...
export async function generateMetadata({ params }) {
  ...
  if (CATEGORIES.includes(slug)) {
    ...
    return {
      title: `Himovies - ${title} Movies`,
      description: `Explore the ${title} movies collection on Himovies.`,
    };
  }
  ...
  if (genreMatch) {
    ...
    return {
      title: `Himovies - ${genreName} Movies`,
      description: `Discover ${genreName} movies on Himovies.`,
    };
  }
