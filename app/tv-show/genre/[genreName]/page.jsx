...
export async function generateMetadata({ params }) {
  ...
  const pageUrl = `https://himovies-us.netlify.app/tv-show/genre/${genreName}`;
  const imageUrl = 'https://live.staticflickr.com/65535/54803471299_d3df3e14c1_b.jpg';

  return {
    title: `Himovies - ${title} TV Series`,
    description: `Find and watch the best ${title} TV series for free on Himovies.`,
    openGraph: {
      title: `Himovies - ${title} TV Series`,
      description: `Find and watch the best ${title} TV series for free on Himovies.`,
      url: pageUrl,
